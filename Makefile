...
HDRS			:=	Config.hpp  Route.hpp Server.hpp HttpRequest.hpp HttpResponse.hpp Socket.hpp SocketManager.hpp DataAdapter.hpp CgiProcessor.hpp FileManager.hpp ServerConstants.hpp
